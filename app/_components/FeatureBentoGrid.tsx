    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          Our AI medical voice agents provide 24/7 access to specialized
          healthcare professionals, delivering personalized care recommendations
          and comprehensive medical reports through natural voice
          conversations...
        </p>
      </motion.div>
      <motion.div
...
const items = [
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Automatically generate detailed, structured medical reports with
